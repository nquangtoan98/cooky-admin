...
import { UserToken } from 'model/user-dto';

@Injectable({
  providedIn: 'root'
})
export class AuthenticationService implements OnInit, OnDestroy{
  private behaviorUserSubject: BehaviorSubject<UserToken>;
  private currentUser : Observable<UserToken>;
  constructor(private httpClient: HttpClient) {
    this.behaviorUserSubject = new BehaviorSubject<UserToken>(JSON.parse(localStorage.getItem('currentUser')));
  ...
  public get getCurrentUser() : UserToken {
